...
function add_css(target) {
  append_styles(target, "svelte-10c6s9u", "svelte-scroller-outer.svelte-10c6s9u{display:block;position:relative}svelte-scroller-background.svelte-10c6s9u{display:block;position:relative;width:100%}svelte-scroller-foreground.svelte-10c6s9u{display:block;position:relative;z-index:2}svelte-scroller-foreground.svelte-10c6s9u::after{content:' ';display:block;clear:both}svelte-scroller-background-container.svelte-10c6s9u{display:block;position:absolute;width:100%;max-width:100%;pointer-events:none;will-change:transform}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      set_custom_element_data(svelte_scroller_background, "class", "svelte-10c6s9u");
      add_location(svelte_scroller_background, file, 173, 2, 3978);
      set_custom_element_data(svelte_scroller_background_container, "class", "background-container svelte-10c6s9u");
      ...
      set_custom_element_data(svelte_scroller_foreground, "class", "svelte-10c6s9u");
      add_location(svelte_scroller_foreground, file, 178, 1, 4140);
      set_custom_element_data(svelte_scroller_outer, "class", "svelte-10c6s9u");
